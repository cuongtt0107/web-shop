<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseProduct" class="collapse" aria-labelledby="headingProduct" data-parent="#accordionSidebar"
           >
            <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo e(BASE_URL.'products'); ?>">Danh sách</a>
                <a class="collapse-item" href="<?php echo e(BASE_URL . 'newproduct'); ?>">Tạo mới</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapseInvoice" class="collapse" aria-labelledby="headingInvoice" data-parent="#accordionSidebar"
           >
            <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo e(BASE_URL.'invoice'); ?>">Danh sách</a>
            </div>
        </div>
    </li>


</ul><?php /**PATH C:\xampp\htdocs\php2_12\buoi3\mvc\app\views/layout/slidebar.blade.php ENDPATH**/ ?>
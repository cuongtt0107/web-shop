...
<head>
    ...
    <title><?php echo $__env->yieldContent("title","Use"); ?></title>
            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-register-image">
                        <img src="url(https://source.unsplash.com/K4mSJ7kc0As/600x800)" alt="">
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                          ...
                          <?php echo $__env->yieldContent("use"); ?>;
...
</html><?php /**PATH C:\xampp\htdocs\php2_12\buoi3\mvc\app\views/layout/main-use.blade.php ENDPATH**/ ?>